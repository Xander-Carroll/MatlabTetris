classdef KeyHandler < handle
    properties (Constant)
        Keys = struct(  'upArrow', 1, 'downArrow', 2, 'leftArrow', 3, 'rightArrow', 4, ...
                        'w', 5, 'a', 6, 's', 7, 'd', 8, 'escape', 9, 'key0', 10, 'key1', 11, 'key2', 12, 'f1', 13, 'f2', 14);
    end
    ...
    methods
        ...
        function onKeyPress(obj, ~, event)
            ...
            elseif(isequal(event.Key, 'f2'))
                obj.currentKeys(obj.Keys.f2) = true;
            end
        ...
        function onKeyRelease(obj, ~, event)
            ...
            elseif(isequal(event.Key, 'f2'))
                obj.currentKeys(obj.Keys.f2) = false;
            end
        end
